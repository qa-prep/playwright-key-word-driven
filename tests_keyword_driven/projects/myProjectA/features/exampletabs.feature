...
Feature: Tab handling
  ...
  @scenarionName.exampletabs.linktabwitch
  ...
  @scenarionName.exampletabs.switchbackorig
  ...
  @scenarionName.exampletabs.multitabswitch
...
#    Then I should see viewport text "I will purposely fail to demo failures"
  ...
  @scenarionName.exampletabs.closetabreturnorig
  ...
  @scenarionName.exampletabs.forcesametab
